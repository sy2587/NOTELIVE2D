...
public class TagController {
    ...
    @PutMapping("/{id}")
    public ApiResponse<TagResponse> update(@PathVariable Long id, @Valid @RequestBody TagRequest body, HttpServletRequest request) {
        return ApiResponse.success(tagService.update(currentUserService.requireUserId(request), id, body));
    }
